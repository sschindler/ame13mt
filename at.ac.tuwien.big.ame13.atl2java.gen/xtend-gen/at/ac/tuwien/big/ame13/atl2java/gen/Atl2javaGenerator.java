...
public class Atl2javaGenerator implements IGenerator {
  ...
  public CharSequence generateTransformationCode(final Transformation t) {
    ...
    _builder.newLine();
    _builder.append("\t\t");
    _builder.append("// problem when pre-creating vectors with all input/output pattern elements:");
    _builder.newLine();
    _builder.append("\t\t");
    _builder.append("// no pre-knowledge about the numbers of input/output pattern elements to create correct number of vectors");
    _builder.newLine();
    _builder.append("\t\t");
    _builder.newLine();
    {
      ...
      for(final Rule rule : _rules) {
        ...
        _builder.newLine();
        {
          ...
          for(final OutputPatternElement ope : _outputPatternElements) {
            ...
            _builder.append("\t\t");
            _builder.append("\t");
            _builder.append("// Binding phase start");
            _builder.newLine();
            {
            ...
            _builder.append("\t\t");
            _builder.append("\t");
            _builder.append("// Binding phase end");
            _builder.newLine();
            _builder.append("\t\t");
            _builder.append("\t");
            _builder.newLine();
