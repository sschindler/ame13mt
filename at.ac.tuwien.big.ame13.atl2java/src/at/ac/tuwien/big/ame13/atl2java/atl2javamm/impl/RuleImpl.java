 ...
 *   <li>{@link at.ac.tuwien.big.ame13.atl2java.atl2javamm.impl.RuleImpl#isAbstract <em>Abstract</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class RuleImpl extends EObjectImpl implements Rule {
	...
	public void setAbstract(boolean newAbstract) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Atl2javaPackage.RULE__ABSTRACT, oldAbstract, abstract_));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case Atl2javaPackage.RULE__ABSTRACT:
				return isAbstract();
		}
