...
/**
 * This is the item provider adapter for a {@link at.ac.tuwien.big.ame13.atl2java.atl2javamm.Rule} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RuleItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 Atl2javaPackage.Literals.RULE__NAME,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(Atl2javaPackage.Literals.RULE__INPUT_PATTERN);
			childrenFeatures.add(Atl2javaPackage.Literals.RULE__OUTPUT_PATTERN);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(Atl2javaPackage.Literals.RULE__INPUT_PATTERN,
				 Atl2javaFactory.eINSTANCE.createInputPattern()));

		newChildDescriptors.add
			(createChildParameter
				(Atl2javaPackage.Literals.RULE__OUTPUT_PATTERN,
				 Atl2javaFactory.eINSTANCE.createOutputPattern()));
	}
