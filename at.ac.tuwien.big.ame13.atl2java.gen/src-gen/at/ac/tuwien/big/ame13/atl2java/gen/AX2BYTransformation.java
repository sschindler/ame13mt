...
public class AX2BYTransformation {

	private static String sourceModel = "testmodel/modelAX.xmi";
	private static String targetModel = "testmodel/outputmodelAX2BY.xmi";
	...
	public static void main(String[] args) throws IOException {
		...
		Resource srcM = mLoader.loadModel("testmodel/AX.ecore", sourceModel);
		
		// Resource srcMM = mLoader.loadMetamodel("testmodel/AX.ecore");
		
		Resource trgMM = mLoader.loadMetamodel("testmodel/BY.ecore");
