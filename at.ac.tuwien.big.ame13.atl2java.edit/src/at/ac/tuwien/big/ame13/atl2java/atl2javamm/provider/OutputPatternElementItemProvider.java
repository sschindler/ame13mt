...
public class OutputPatternElementItemProvider
	...
	protected void addModelPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_OutputPatternElement_model_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_OutputPatternElement_model_feature", "_UI_OutputPatternElement_type"),
				 Atl2javaPackage.Literals.OUTPUT_PATTERN_ELEMENT__MODEL,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(OutputPatternElement.class)) {
			...
			case Atl2javaPackage.OUTPUT_PATTERN_ELEMENT__MODEL:
		...
		newChildDescriptors.add
			(createChildParameter
				(Atl2javaPackage.Literals.OUTPUT_PATTERN_ELEMENT__BINDINGS,
				 Atl2javaFactory.eINSTANCE.createBinding()));
	}
