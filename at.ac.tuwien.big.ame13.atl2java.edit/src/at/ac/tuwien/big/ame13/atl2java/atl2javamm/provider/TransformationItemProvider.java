...
public class TransformationItemProvider
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(Atl2javaPackage.Literals.TRANSFORMATION__SOURCE_MODELS);
			childrenFeatures.add(Atl2javaPackage.Literals.TRANSFORMATION__TARGET_MODELS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(Atl2javaPackage.Literals.TRANSFORMATION__SOURCE_MODELS,
				 Atl2javaFactory.eINSTANCE.createModel()));

		newChildDescriptors.add
			(createChildParameter
				(Atl2javaPackage.Literals.TRANSFORMATION__TARGET_MODELS,
				 Atl2javaFactory.eINSTANCE.createModel()));
	}
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			childFeature == Atl2javaPackage.Literals.TRANSFORMATION__SOURCE_MODELS ||
			childFeature == Atl2javaPackage.Literals.TRANSFORMATION__TARGET_MODELS;
