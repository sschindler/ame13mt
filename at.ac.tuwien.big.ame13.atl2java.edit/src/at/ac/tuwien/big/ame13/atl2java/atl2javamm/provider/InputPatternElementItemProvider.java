...
/**
 * This is the item provider adapter for a {@link at.ac.tuwien.big.ame13.atl2java.atl2javamm.InputPatternElement} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class InputPatternElementItemProvider
	 ...
	 * @generated
	 */
	public InputPatternElementItemProvider(AdapterFactory adapterFactory) {
	...
	protected void addTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_InputPatternElement_type_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_InputPatternElement_type_feature", "_UI_InputPatternElement_type"),
				 Atl2javaPackage.Literals.INPUT_PATTERN_ELEMENT__TYPE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addModelPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_InputPatternElement_model_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_InputPatternElement_model_feature", "_UI_InputPatternElement_type"),
				 Atl2javaPackage.Literals.INPUT_PATTERN_ELEMENT__MODEL,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	/**
	 * This returns InputPatternElement.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/InputPatternElement"));
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(InputPatternElement.class)) {
			...
			case Atl2javaPackage.INPUT_PATTERN_ELEMENT__MODEL:
