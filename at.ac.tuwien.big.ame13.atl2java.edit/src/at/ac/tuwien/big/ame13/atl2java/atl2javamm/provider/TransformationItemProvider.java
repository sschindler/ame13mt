...
/**
 * This is the item provider adapter for a {@link at.ac.tuwien.big.ame13.atl2java.atl2javamm.Transformation} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TransformationItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 Atl2javaPackage.Literals.TRANSFORMATION__NAME,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(Atl2javaPackage.Literals.TRANSFORMATION__RULES);
			childrenFeatures.add(Atl2javaPackage.Literals.TRANSFORMATION__SOURCE_MODEL);
			childrenFeatures.add(Atl2javaPackage.Literals.TRANSFORMATION__TARGET_MODEL);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(Atl2javaPackage.Literals.TRANSFORMATION__RULES,
				 Atl2javaFactory.eINSTANCE.createRule()));

		newChildDescriptors.add
			(createChildParameter
				(Atl2javaPackage.Literals.TRANSFORMATION__SOURCE_MODEL,
				 Atl2javaFactory.eINSTANCE.createSourceModel()));

		newChildDescriptors.add
			(createChildParameter
				(Atl2javaPackage.Literals.TRANSFORMATION__TARGET_MODEL,
				 Atl2javaFactory.eINSTANCE.createTargetModel()));
	}
