...
public class Atl2javaGenerator implements IGenerator {
  ...
  public CharSequence generateTransformationCode(final Transformation t) {
    ...
    _builder.newLine();
    _builder.append("\t\t\t\t\t\t\t");
    _builder.append("tempList = tl.getTargetElements();");
    _builder.newLine();
    _builder.append("\t\t\t\t\t\t\t");
    _builder.append("for(TransientElement tempTE : tempList) {");
    _builder.newLine();
    ...
    _builder.newLine();
    _builder.append("\t\t\t\t\t\t");
    _builder.append("// f2Value instanceof String");
    _builder.newLine();
    _builder.append("\t\t\t\t\t\t");
    ...
    _builder.newLine();
    _builder.append("\t\t\t\t\t\t");
    _builder.append("boolean resFromTargetElements = false;");
    _builder.newLine();
    _builder.append("\t\t\t\t\t\t");
    _builder.newLine();
    _builder.append("\t\t\t\t\t\t");
    _builder.append("if(resElement == null) {");
    _builder.newLine();
    _builder.append("\t\t\t\t\t\t\t");
    _builder.append("// resolving by target element");
    _builder.newLine();
    _builder.append("\t\t\t\t\t\t\t");
    _builder.append("tempList = tl.getTargetElements();");
    _builder.newLine();
    ...
    _builder.newLine();
    _builder.append("\t\t\t\t\t\t\t\t\t");
    _builder.append("resFromTargetElements = true;");
    _builder.newLine();
    _builder.append("\t\t\t\t\t\t\t\t\t");
    _builder.append("break;");
    _builder.newLine();
    ...
    _builder.newLine();
    _builder.append("\t\t\t\t\t\t\t");
    _builder.append("if(!resFromTargetElements) {");
    _builder.newLine();
    _builder.append("\t\t\t\t\t\t\t\t");
