 ...
 *   <li>{@link at.ac.tuwien.big.ame13.atl2java.atl2javamm.impl.InputPatternElementImpl#getModel <em>Model</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class InputPatternElementImpl extends EObjectImpl implements InputPatternElement {
	...
	public void setModel(String newModel) {
		...
		model = newModel;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Atl2javaPackage.INPUT_PATTERN_ELEMENT__MODEL, oldModel, model));
	}
