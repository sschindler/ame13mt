...
public class Atl2javaGenerator implements IGenerator {
  ...
  public CharSequence generateTransformationCode(final Transformation t) {
    ...
    _builder.newLine();
    _builder.append("\t");
    _builder.append("private static String sourceModel = \"testmodel/modelA.xmi\";");
    _builder.newLine();
    _builder.append("\t");
    _builder.append("private static String targetModel = \"testmodel/outputmodel");
    ...
    _builder.newLine();
    _builder.append("\t");
    _builder.append("@SuppressWarnings({ \"unused\", \"unchecked\" })");
    _builder.newLine();
    _builder.append("\t");
    ...
    _builder.newLine();
    _builder.append("\t\t");
    _builder.append("// HashMap<trgObject,HashMap<trgFeature,outputpatternelement_value>");
    _builder.newLine();
    _builder.append("\t\t");
    ...
    _builder.newLine();
    _builder.append("\t\t");
    _builder.append("// HashMap<trgObject,HashMap<trgFeature,resolution_value>");
    _builder.newLine();
    _builder.append("\t\t");
    _builder.append("HashMap<EObject,HashMap<String,String>> rBindings = new HashMap<EObject,HashMap<String,String>>();");
    _builder.newLine();
    _builder.append("\t\t");
    _builder.append("HashMap<String,String> rBHM;");
    _builder.newLine();
    _builder.append("\t\t");
    _builder.newLine();
    _builder.append("\t\t");
    _builder.append("// HashMap<srcObject,transientlink>");
    _builder.newLine();
    _builder.append("\t\t");
    _builder.append("HashMap<EObject,TransientLink> tLinkBySrcObj = new HashMap<EObject,TransientLink>();");
    _builder.newLine();
    _builder.append("\t\t");
    _builder.newLine();
    {
      ...
      for(final Rule rule : _rules) {
        _builder.append("\t\t");
        _builder.append("// contains the number of source elements defined by each input pattern type of this rule");
        _builder.newLine();
        _builder.append("\t\t");
        ...
        _builder.newLine();
        {
          ...
          for(final InputPatternElement ipe_1 : _inputPatternElements_1) {
            ...
            _builder.append("\t\t");
            _builder.append("\t");
            _builder.append("tLinkBySrcObj.put(srcObj, tl);");
            _builder.newLine();
          }
        }
        _builder.append("\t\t");
        ...
        _builder.append("\t\t");
        _builder.append("\t");
        _builder.append("// creating all target elements and saving the transient target elements in the link");
        _builder.newLine();
        {
              ...
              for(final Binding binding : _bindings) {
                {
                  if ((binding instanceof PrimitiveBinding)) {
                    ...
                    String _value = ((PrimitiveBinding) binding).getValue();
                    ...
                    if ((binding instanceof NavigationBinding)) {
                      {
                        if ((binding instanceof ResolveBinding)) {
                          _builder.append("\t\t");
                          _builder.append("\t");
                          _builder.append("if(rBindings.containsKey(trgObj)) {");
                          _builder.newLine();
                          _builder.append("\t\t");
                          _builder.append("\t");
                          _builder.append("\t");
                          _builder.append("rBHM = rBindings.get(trgObj);");
                          _builder.newLine();
                          _builder.append("\t\t");
                          _builder.append("\t");
                          _builder.append("\t");
                          _builder.append("// if there is already a resolve binding for this feature don\'t overwrite the existing value");
                          _builder.newLine();
                          _builder.append("\t\t");
                          _builder.append("\t");
                          _builder.append("\t");
                          _builder.append("if(!rBHM.containsKey(\"");
                          ...
                          _builder.append("\t");
                          _builder.append("\t\t");
                          _builder.append("rBHM.put(\"");
                          String _feature_2 = binding.getFeature();
                          _builder.append(_feature_2, "					");
                          _builder.append("\", \"");
                          InputPatternElement _inputPatternElement = ((ResolveBinding) binding).getInputPatternElement();
                          String _name_4 = _inputPatternElement.getName();
                          _builder.append(_name_4, "					");
                          _builder.append(".");
                          String _value_1 = ((ResolveBinding) binding).getValue();
                          ...
                          _builder.append("\t");
                          _builder.append("\t\t");
                          _builder.append("rBindings.put(trgObj, rBHM);");
                          _builder.newLine();
                          _builder.append("\t\t");
                          _builder.append("\t");
                          _builder.append("\t");
                          ...
                          _builder.append("\t");
                          _builder.append("\t");
                          _builder.append("rBHM = new HashMap<String,String>();");
                          _builder.newLine();
                          _builder.append("\t\t");
                          _builder.append("\t");
                          _builder.append("\t");
                          ...
                          _builder.append("\", \"");
                          InputPatternElement _inputPatternElement_1 = ((ResolveBinding) binding).getInputPatternElement();
                          String _name_5 = _inputPatternElement_1.getName();
                          _builder.append(_name_5, "				");
                          _builder.append(".");
                          String _value_2 = ((ResolveBinding) binding).getValue();
                          ...
                          _builder.append("\t");
                          _builder.append("\t");
                          _builder.append("// if there is already a navigation binding for this feature don\'t overwrite the existing value");
                          _builder.newLine();
                          _builder.append("\t\t");
                          _builder.append("\t");
                          _builder.append("\t");
                          ...
                          _builder.append("\", \"");
                          InputPatternElement _inputPatternElement_2 = ((NavigationBinding) binding).getInputPatternElement();
                          String _name_6 = _inputPatternElement_2.getName();
                          _builder.append(_name_6, "					");
                          _builder.append(".");
                          String _value_3 = ((NavigationBinding) binding).getValue();
                          ...
                          _builder.append("\", \"");
                          InputPatternElement _inputPatternElement_3 = ((NavigationBinding) binding).getInputPatternElement();
                          String _name_7 = _inputPatternElement_3.getName();
                          _builder.append(_name_7, "				");
                          _builder.append(".");
                          String _value_4 = ((NavigationBinding) binding).getValue();
                      ...
                      if ((binding instanceof OutputpatternElementBinding)) {
                        ...
                        _builder.append("\t");
                        _builder.append("\t");
                        _builder.append("// if there is already a output pattern element binding for this feature don\'t overwrite the existing value");
                        _builder.newLine();
                        _builder.append("\t\t");
                        _builder.append("\t");
                        _builder.append("\t");
                        _builder.append("if(!oPEBHM.containsKey(\"");
                        String _feature_7 = binding.getFeature();
                        _builder.append(_feature_7, "				");
                        _builder.append("\")) {");
                        _builder.newLineIfNotEmpty();
                        _builder.append("\t\t");
                        _builder.append("\t");
                        ...
                        String _feature_8 = binding.getFeature();
                        _builder.append(_feature_8, "					");
                        _builder.append("\", \"");
                        OutputPatternElement _value_5 = ((OutputpatternElementBinding) binding).getValue();
                        String _name_8 = _value_5.getName();
                        ...
                        _builder.append("\t");
                        _builder.append("oPEBHM.put(\"");
                        String _feature_9 = binding.getFeature();
                        _builder.append(_feature_9, "				");
                        _builder.append("\", \"");
                        OutputPatternElement _value_6 = ((OutputpatternElementBinding) binding).getValue();
                        String _name_9 = _value_6.getName();
    ...
    _builder.newLine();
    _builder.append("\t\t\t\t\t\t");
    _builder.append("// navigation string: var.feature");
    _builder.newLine();
    _builder.append("\t\t\t\t\t\t");
    ...
    _builder.newLine();
    _builder.append("\t\t\t\t\t\t");
    _builder.append("// tl.getSourceElementByVar(navigation[0]) in TransientLinkImpl.java faulty (getValue() instead of getVar())");
    _builder.newLine();
    _builder.append("\t\t\t\t\t\t");
    _builder.append("EList<TransientElement> tempList = tl.getSourceElements();");
    _builder.newLine();
    _builder.append("\t\t\t\t\t\t");
    _builder.append("for(TransientElement tempTE : tempList) {");
    _builder.newLine();
    _builder.append("\t\t\t\t\t\t\t");
    _builder.append("if(tempTE.getVar().equals(navigation[0])) {");
    _builder.newLine();
    _builder.append("\t\t\t\t\t\t\t\t");
    _builder.append("navElement = tempTE.getValue();");
    _builder.newLine();
    _builder.append("\t\t\t\t\t\t\t\t");
    ...
    _builder.newLine();
    _builder.append("\t\t\t\t\t\t");
    _builder.append("// f2Value of primitve type (e.g. f2Value instanceof String)");
    _builder.newLine();
    _builder.append("\t\t\t\t\t\t");
    ...
    _builder.newLine();
    _builder.append("\t\t\t\t\t\t");
    _builder.append("// output pattern element string: var");
    _builder.newLine();
    _builder.append("\t\t\t\t\t\t");
    ...
    _builder.newLine();
    _builder.append("\t\t\t\t\t\t");
    _builder.append("EList<TransientElement> tempList = tl.getTargetElements();");
    _builder.newLine();
    _builder.append("\t\t\t\t\t\t");
    _builder.append("for(TransientElement tempTE : tempList) {");
    _builder.newLine();
    _builder.append("\t\t\t\t\t\t\t");
    _builder.append("if(tempTE.getVar().equals(var)) {");
    _builder.newLine();
    _builder.append("\t\t\t\t\t\t\t\t");
    _builder.append("varElement = tempTE.getValue();");
    _builder.newLine();
    _builder.append("\t\t\t\t\t\t\t\t");
    _builder.append("break;");
    _builder.newLine();
    ...
    _builder.newLine();
    _builder.append("\t\t\t\t");
    _builder.append("if(rBindings.containsKey(obj)) {");
    _builder.newLine();
    _builder.append("\t\t\t\t\t");
    _builder.append("HashMap<String,String> rBinding = rBindings.get(obj);");
    _builder.newLine();
    _builder.append("\t\t\t\t\t");
    _builder.append("Set<String> rBindingFeatures = rBinding.keySet();");
    _builder.newLine();
    _builder.append("\t\t\t\t\t");
    _builder.append("for(String rBindingFeature : rBindingFeatures) {");
    _builder.newLine();
    _builder.append("\t\t\t\t\t\t");
    _builder.append("EStructuralFeature f = obj.eClass().getEStructuralFeature(rBindingFeature);");
    _builder.newLine();
    _builder.append("\t\t\t\t\t\t");
    _builder.newLine();
    _builder.append("\t\t\t\t\t\t");
    _builder.append("// resolve string: var.feature");
    _builder.newLine();
    _builder.append("\t\t\t\t\t\t");
    _builder.append("String[] navigation = rBinding.get(rBindingFeature).split(\"\\\\.\");");
    _builder.newLine();
    _builder.append("\t\t\t\t\t\t");
    _builder.newLine();
    _builder.append("\t\t\t\t\t\t");
    _builder.append("EObject resElement = null;");
    _builder.newLine();
    _builder.append("\t\t\t\t\t\t");
    _builder.append("EList<TransientElement> tempList = tl.getSourceElements();");
    _builder.newLine();
    ...
    _builder.newLine();
    _builder.append("\t\t\t\t\t\t\t\t");
    _builder.append("resElement = tempTE.getValue();");
    _builder.newLine();
    _builder.append("\t\t\t\t\t\t\t\t");
    _builder.append("break;");
    _builder.newLine();
    ...
    _builder.newLine();
    _builder.append("\t\t\t\t\t\t");
    _builder.append("EStructuralFeature f2 = resElement.eClass().getEStructuralFeature(navigation[1]);");
    _builder.newLine();
    _builder.append("\t\t\t\t\t\t");
    _builder.append("Object f2Value = resElement.eGet(f2);");
    _builder.newLine();
    _builder.append("\t\t\t\t\t\t");
    _builder.newLine();
    _builder.append("\t\t\t\t\t\t");
    _builder.append("if(f2Value instanceof EObject) ");
    _builder.newLine();
    _builder.append("\t\t\t\t\t\t");
    _builder.append("{");
    _builder.newLine();
    _builder.append("\t\t\t\t\t\t\t");
    _builder.append("// f2Value is one object");
    _builder.newLine();
    _builder.append("\t\t\t\t\t\t\t");
    _builder.newLine();
    _builder.append("\t\t\t\t\t\t\t");
    _builder.append("EObject f2Object = (EObject) f2Value;");
    _builder.newLine();
    _builder.append("\t\t\t\t\t\t\t");
    _builder.append("TransientLink tlTemp = tLinkBySrcObj.get(f2Object);");
    _builder.newLine();
    _builder.append("\t\t\t\t\t\t\t");
    _builder.newLine();
    _builder.append("\t\t\t\t\t\t\t");
    _builder.append("if(tlTemp != null) {");
    _builder.newLine();
    _builder.append("\t\t\t\t\t\t\t\t");
    _builder.append("EList<TransientElement> targets = tlTemp.getTargetElements();");
    _builder.newLine();
    _builder.append("\t\t\t\t\t\t\t\t");
    _builder.append("if(targets.size() > 1) {");
    _builder.newLine();
    _builder.append("\t\t\t\t\t\t\t\t\t");
    ...
    _builder.newLine();
    _builder.append("\t\t\t\t\t\t\t\t\t");
    _builder.append("EObject f2TObject = targets.get(0).getValue();");
    _builder.newLine();
    _builder.append("\t\t\t\t\t\t\t\t\t");
    _builder.append("obj.eSet(f, f2TObject);");
    _builder.newLine();
    _builder.append("\t\t\t\t\t\t\t\t");
    _builder.append("}");
    _builder.newLine();
    ...
    _builder.newLine();
    _builder.append("\t\t\t\t\t\t\t");
    _builder.append("// f2Value is a list of objects");
    _builder.newLine();
    _builder.append("\t\t\t\t\t\t\t");
    _builder.newLine();
    _builder.append("\t\t\t\t\t\t\t");
    ...
    _builder.newLine();
    _builder.append("\t\t\t\t\t\t\t\t");
    _builder.append("TransientLink tlTemp = tLinkBySrcObj.get(srcElement);");
    _builder.newLine();
    _builder.append("\t\t\t\t\t\t\t\t");
    _builder.append("if(tlTemp != null) {");
    _builder.newLine();
    ...
    _builder.newLine();
    _builder.append("\t\t");
    _builder.append("Resource resource = resourceSet.createResource(URI.createFileURI(targetModel));");
    _builder.newLine();
    _builder.append("\t\t");
