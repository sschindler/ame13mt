...
public class Atl2javaGenerator implements IGenerator {
  ...
  public CharSequence generateTransformationCode(final Transformation t) {
    ...
    SourceModel _sourceModel_4 = t.getSourceModel();
    String _name_1 = _sourceModel_4.getName();
    ...
    TargetModel _targetModel_2 = t.getTargetModel();
    String _name_2 = _targetModel_2.getName();
